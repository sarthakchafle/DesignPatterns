...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            PaymentService paymentService = new PaymentService(new CardPaymentStrategy(), bookingService);
            ...
            System.out.println("User created: " + user.getName() + " with email: " + user.getName());
